...
const PRICING_FACTORS = [
  {
    ...
    example: "Small parcel: GBP 18 - Pallet: GBP 72 - Freight: GBP 145",
  },
  {
    title: "Mileage",
    description:
    ...
    example: "Medium parcel: GBP 1.05/mile - Freight: GBP 2.60/mile",
  },
  {
    title: "Service Speed",
    description:
    ...
    example: "Same-day: 1.85x - Next-day: 1x - Scheduled: 0.86x",
  },
  {
    ...
    example: "GBP 0.65/kg over category limit",
  },
  {
    title: "Handling Fees",
    description:
    ...
    example: "Tail-lift: GBP 25 - Temperature: GBP 32 - Two-person: GBP 45",
  },
  {
